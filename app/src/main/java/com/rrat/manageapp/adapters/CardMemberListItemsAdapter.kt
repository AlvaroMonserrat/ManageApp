...
import com.rrat.manageapp.databinding.ItemCardSelectedMemberBinding
...
open class CardMemberListItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        binding = ItemCardSelectedMemberBinding.inflate(LayoutInflater.from(parent.context), parent, false)
